...
import styled, { injectGlobal, ThemeProvider, StyledFunction, withprops, css } from 'src/styled-components'

export const Box = withprops<IPropsBox>()(styled.div) `
...
function display(props: IPropsBox) {
  if (props.flexcol) {
    return 'flex'
  }
  if (props.flexrow) {
...
function position(props: IPropsBox) {
...
function flexDirection(props: IPropsBox): string {
  if (props.flexcol) {
    return 'column'
  }
  return 'row'
...
function flexWrap(props: IPropsBox): string {
  if (props.wrap) {
    return 'wrap'
  }
  return 'nowrap'
}
function flex(props: IPropsBox): string {
...
function size(props: IPropsBox, key: string): string {
...
function alignItems(props: IPropsBox) {
  if (props.aicenter) {
    return 'center'
  }
  if (props.ainormal) {
...
function justifyContent(props: IPropsBox) {
  if (props.jccenter) {
    return 'center'
  }
...
function alignContent(props: IPropsBox) {
  if (props.accenter) {
    return 'center'
  }
